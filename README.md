...
| :--- | :--- |
| **Web Core** | `React` `Node.js` `MongoDB` `Django` `JavaScript` `PHP` |
| **Languages** | `Python` `Java` `C#` `C++` `C` `.NET` |
| **Design / Game** | `Unreal Engine` `Photoshop` `Illustrator` |
| **OS / DB** | `Linux` `MySQL` `Android` |

<p align="left">
  <img src="https://skillicons.dev/icons?i=react,nodejs,mongodb,py,django,js,html,css,bootstrap,java,cpp,cs,php,dotnet,mysql,android,unreal,linux,ps,ai" />
</p>
...
<div align="left">
  ...
  <a href="mailto:rohanram86@gmail.com">
